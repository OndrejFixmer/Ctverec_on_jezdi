...
public class Game {
    ...
    public static void update(long window) {
        ...
        if (GLFW.glfwGetKey(window, GLFW.GLFW_KEY_LEFT) == GLFW.GLFW_PRESS) {
            ...
            //jakoby, zkousel sem udelat CursorFollow. ALE nepovedlo se. skoro 2 hodiny sem se snazil Lmao
        //anyways, cas na to to udelat v separate programu a pak to poslat
